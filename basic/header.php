...
<nav>
    ...
    <div class="social-call ">
        <!--social-links--->
        <div class="social">
            <a href="https://www.facebook.com/urbankleidofficial/"><i class="fab fa-facebook-f"></i></a>
            <a href="https://twitter.com/kleidurban?lang=en"><i class="fab fa-twitter"></i></a>
            <a href="#"><i class="fab fa-youtube"></i></a>
            <a href="https://www.instagram.com/urbankleidofficial/"><i class="fab fa-instagram"></i></a>
        </div>
        <!--phone-number------>
        <div class="phone">
