...
if((strtolower($squery)=="Aneesh Kumar") || (strtolower($squery)=="aneesh kumar")){
   ...
   <div class="container">
     ...
     <a href="https://www.facebook.com/profile.php?id=100006921490253" target="_blank" type="button" class="btn btn-danger"> <i class="fa fa-user-secret" aria-hidden="true"></i> Sachin Prajpati</a>
 ...
 var i = 0,
 text;
 text = "This website made by Aneesh Kumar ,Sandeep Kumar and Shiv kumar Shukla. ";
